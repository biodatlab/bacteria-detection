...
custom_hooks = [
    ...
    dict(type='SyncNormHook', num_last_epochs=15, interval=20, priority=48),
    dict(
...
model = dict(
    ...
    neck=dict(
        ...
        num_csp_blocks=2),
    bbox_head=dict(
        type='YOLOXHead', num_classes=8, in_channels=192, feat_channels=192),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            '/home/badboy-002/github/senior_project/bacteria_img_jbing/split_coco_jbing/merge_all_train_jbing.json',
            img_prefix=
            '/home/badboy-002/github/senior_project/bacteria_img_jbing',
            classes=('unt', 'Amp', 'Cip', 'Rif', 'Tet', 'Col', 'Kan', 'Mec'),
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True)
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/home/badboy-002/github/senior_project/bacteria_img_jbing/split_coco_jbing/merge_all_test_jbing.json',
        img_prefix='/home/badboy-002/github/senior_project/bacteria_img_jbing',
        classes=('unt', 'Amp', 'Cip', 'Rif', 'Tet', 'Col', 'Kan', 'Mec'),
        pipeline=[
            dict(type='LoadImageFromFile'),
