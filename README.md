...
* **Deep Mask-heads Above CenterNet (Deep-MAC)** for instance segmentation from the bouding box given by object detection models
* **Open-CV** for features extraction 



For qualitative analysis, you can see example bounding box 
## Dataset
...
- Download virtual environment from [here]()
- extract virtual environment
...
### Download Weight
Download weigh of all models [here](https://drive.google.com/drive/folders/1S8LEIkAcTxg5MJtzbsWkIeIt-Ayp5Mzz?usp=sharing)
...
$ npm start
```
Image of web application with predicted results
