...
train_coco_path = '/home/badboy-002/github/senior_project/bacteria_img_jbing/split_coco_jbing/train_0_fold.json'
test_coco_path = '/home/badboy-002/github/senior_project/bacteria_img_jbing/split_coco_jbing/merge_all_test_jbing.json'
val_coco_path = '/home/badboy-002/github/senior_project/bacteria_img_jbing/split_coco_jbing/val_0_fold.json'
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=val_coco_path,
        img_prefix=image_path,  
        classes=CLASSES,
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=val_coco_path, # change to val to re-collect the data
        img_prefix=image_path ,
        classes=CLASSES,
        pipeline=test_pipeline)
    )
